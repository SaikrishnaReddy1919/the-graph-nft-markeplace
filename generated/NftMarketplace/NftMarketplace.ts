...
export class UdpateListingCall extends ethereum.Call {
  get inputs(): UdpateListingCall__Inputs {
    return new UdpateListingCall__Inputs(this);
  }

  get outputs(): UdpateListingCall__Outputs {
    return new UdpateListingCall__Outputs(this);
  }
}

export class UdpateListingCall__Inputs {
  _call: UdpateListingCall;

  constructor(call: UdpateListingCall) {
    this._call = call;
  }
...
export class UdpateListingCall__Outputs {
  _call: UdpateListingCall;
