...
### Working version :
- Current version of the deployed subgraph api url is :
    [https://api.studio.thegraph.com/query/38220/nft-marketplace/v0.0.2](https://api.studio.thegraph.com/query/38220/nft-marketplace/v0.0.2)
